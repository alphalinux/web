...
<HTML>
<HEAD>
<TITLE>AlphaLinux - Add A New SRM Revision To The ALOHcl Database</TITLE>
    ...
    <TR VALIGN="top">
      ...
      <TD BGCOLOR="#DC9D33">
        ...
        <TR> <TD WIDTH=10></TD>
            ...
            </B></FONT><P><FONT SIZE="+2"><B>Add A New SRM Revision To The ALO Hardware Database</B></FONT>
		
		<FORM ACTION=add.php?action=addsrm METHOD=POST>
		<CENTER><TABLE CELLSPACING=10>

			<TR><TD>New Revision (Ex: A5.5-82):</TD>
			<TD><input type=text size=30 name=Revision></TD></TR>

			<TR><TD ALIGN=CENTER COLSPAN=2><INPUT TYPE=submit VALUE="Add Revision"></TD></TR>
